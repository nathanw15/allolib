...
set(RTAUDIO_INCLUDE_DIRS external/rtaudio)
...
if(${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
    ...
    list(APPEND RTAUDIO_LIBRARIES ${COREAUDIO_LIB} ${COREFOUNDATION_LIB} pthread)
...
if(${CMAKE_SYSTEM_NAME} MATCHES "Windows")
    ...
    list(APPEND RTAUDIO_LIBRARIES ole32 winmm ksuser uuid)
...
list(APPEND RTAUDIO_DEFINITIONS -DAL_AUDIO_RTAUDIO)